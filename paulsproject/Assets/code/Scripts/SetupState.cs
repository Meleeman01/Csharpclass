...
namespace Assets.Code.States
{
	public class SetupState : IStateBase
	{
		...
		public void ShowIt()
		{
			...
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//below lies the GUI for player color options.
			...
			GUI.Label(new Rect(Screen.width/2-95,Screen.height-100,200,30), "Hold Spacebar to Pause Rotation");

			if(GUI.Button(new Rect(Screen.width/2 -100, Screen.height- 50, 200, 40), "Click Here or Press 'P' to Play")||
